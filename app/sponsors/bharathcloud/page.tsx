    ...
    <div className="min-h-screen flex items-center justify-center py-8 sm:py-12 px-4 sm:px-6">
      <div className="w-full max-w-4xl z-10 backdrop-blur-xl bg-white/10 border border-white/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl text-center text-white">
        ...
        <div className="text-left space-y-4 text-sm sm:text-base leading-relaxed text-white/90">
          <p>
            BharathCloud is one of India's rapidly advancing cloud technology providers, known for delivering secure, scalable and future-ready digital infrastructure solutions. With a strong progress driven foundation, BharathCloud empowers businesses, developers and institutions with high-performance computing, advanced storage, and reliable cloud deployment environments.
          </p>

          <p className="leading-relaxed">
            Their services are built on robust architecture, strong data protection standards and efficient automation practices that ensure speed, stability and uninterrupted workflows. By combining modern cloud engineering with practical usability, BharathCloud enables organisations to scale effortlessly, optimise costs and embrace digital transformation with confidence.
          </p>

          <p className="leading-relaxed">
            Every solution at BharathCloud reflects precision, transparency and long-term reliability. From virtual machines to managed databases, DevOps pipelines, AI-ready platforms and container based infrastructure, the team ensures seamless integration and frictionless operations. Their commitment extends to empowering teams through training resources, optimisation guidance and hands-on technical support for continuous performance improvement.
          </p>
          ...
          <ul className="space-y-3 list-disc list-inside pl-4 text-white/90">
            <li>
              Partnering with BharathCloud gives Datanyx a powerful technology backbone, ensuring students gain exposure to real digital infrastructure that modern solutions are built on. With hands-on expertise in cloud engineering, BharathCloud helps participants understand how scalable systems support development at any level.
            </li>
            <li>
              Having a cloud technology partner reflects Datanyx's belief that student learning journey must be supported by strong digital foundations. Together, BharathCloud and Datanyx encourage engineering that is intelligent, scalable and designed to shape the future of modern computing.
            </li>
          </ul>
        </div>
      </div>
