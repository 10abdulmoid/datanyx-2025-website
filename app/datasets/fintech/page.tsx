      ...
      <CometCard className="w-full h-full">
        ...
        >
          ...
          <motion.div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center py-8">
            <div className="p-4 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 mb-4 group-hover:scale-110 transition-transform duration-300">
              <Lock size={32} />
            </div>
            
            <motion.h3 className="text-xl md:text-2xl font-bold text-white mb-2 group-hover:text-blue-400 transition-colors">
              {idea.publicTitle}
            </motion.h3>
          ...
          <div className="relative z-10">
            {!isUnlocked ? (
              ...
              <div className="flex flex-col items-center text-center py-8">
                <div className="w-20 h-20 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-6 border border-blue-500/20 text-blue-400">
                  <Lock size={40} />
                </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full bg-black/40 border ${
                        error ? 'border-red-500 text-red-200' : 'border-white/10 focus:border-blue-500/50 text-white'
              ...
              >
                ...
                <a 
                  ...
                  className="w-full bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-500/20"
                >
                  <Download size={20} />
