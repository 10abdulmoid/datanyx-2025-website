  ...
  return (
    ...
    >
      <CometCard className="w-full h-full">
        <div
          className="relative flex w-full h-full flex-col items-stretch rounded-[16px] md:rounded-[20px] bg-black/40 backdrop-blur-md border border-yellow-500/30 p-4 md:p-6 group"
          style={{ transformStyle: "preserve-3d" }}
        >
          <div className="absolute -inset-2 bg-gradient-to-br from-yellow-500/20 to-orange-500/20 opacity-0 group-hover:opacity-10 transition-opacity duration-500 -z-10 rounded-[20px]" />
          
          <motion.div className="relative z-10 flex-1 flex flex-col items-center justify-center text-center py-8">
            <div className="p-4 rounded-full bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 mb-4 group-hover:scale-110 transition-transform duration-300">
              <Lock size={32} />
            </div>
            
            <motion.h3 className="text-xl md:text-2xl font-bold text-white mb-2 group-hover:text-yellow-400 transition-colors">
              {idea.publicTitle}
            </motion.h3>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative w-full max-w-2xl flex flex-col rounded-[32px] bg-black/90 border border-yellow-500/30 overflow-hidden shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="relative p-8 md:p-10">
          <div className="absolute inset-0 bg-gradient-to-br from-yellow-500/10 to-orange-500/10 opacity-50" />
          ...
          <div className="relative z-10">
            {!isUnlocked ? (
              ...
              <div className="flex flex-col items-center text-center py-8">
                <div className="w-20 h-20 bg-yellow-500/10 rounded-2xl flex items-center justify-center mb-6 border border-yellow-500/20 text-yellow-400">
                  <Lock size={40} />
                </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={`w-full bg-black/40 border ${
                        error ? 'border-red-500 text-red-200' : 'border-white/10 focus:border-yellow-500/50 text-white'
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <div className="p-4 rounded-2xl bg-yellow-500/20 border border-yellow-500/30 text-yellow-400">
                    <Unlock size={32} />
                  </div>
                  <div>
                ...
                <div className="space-y-6 text-white/80 leading-relaxed mb-8">
                  <div>
                    <h3 className="text-sm uppercase tracking-wider text-yellow-400 font-bold mb-2">Description</h3>
                    <p>{idea.private.description}</p>
                  </div>
                  
                  <div>
                    <h3 className="text-sm uppercase tracking-wider text-yellow-400 font-bold mb-2">Details</h3>
                ...
                <a 
                  ...
                  className="w-full bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-2 shadow-lg shadow-yellow-500/20"
                >
                  <Download size={20} />
      ...
      <div className="flex-grow container mx-auto px-4 relative z-10">
        ...
        <div className="pt-40 sm:pt-48 md:pt-56 lg:pt-64 pb-8 md:pb-12 text-center">
          ...
          {/* <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto">
            Explore curated datasets and project ideas to kickstart your innovation in educational technology.
          </p> */}
        </div>
