  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
        ...
        <div
          className="absolute top-60 left-1/3 w-1 h-1 rounded-full bg-blue-300/80 animate-ping"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-40 right-1/3 w-1 h-1 rounded-full bg-blue-300/70 animate-ping"
