...
const FAQS = [
  ...
  {
    q: "What are the eligibility criteria for participating?",
    a: " Datanyx 2.0 is open to undergraduate students. Each team must consist of 2 to 4 members from the same or different institutions.",
  },
  {
    q: " Is there a participation fee?",
    a: " Registration is completely free of cost. However, teams that are shortlisted for the final 24-hour Datathon will be required to pay a participation fee of ₹800.",
  },
  {
    q: " Can we submit more than one problem statement?",
    a: "No, each team is allowed to work on and submit only one problem statement during Datanyx 2.0.",
  },
  {
    q: "Will teams get to choose their problem statements?",
    a: "No, problem statements will be assigned randomly on the day of the event. Once assigned, teams must work on that statement for the duration of the Datathon.",
  },
  {
    q: "Can students from different colleges form a team?",
    a: " Yes! Inter-college teams are allowed and encouraged to promote collaboration and diversity of ideas.",
  },
  {
    q: "What are the judging criteria?",
    a: "Projects will be evaluated based on innovation, novelty, technical implementation, relevance to the problem statement, creativity, and presentation quality.",
  },
  {
    q: "Will there be prizes for winners?",
    a: " Yes, attractive cash prizes, goodies, and certificates will be awarded to the top-performing teams.",
  },
  {
    q: "Who can we contact for queries or assistance?",
    a: "For any questions or support, participants can reach out through the contact on the website or connect with the organizing team via email or social media handles provided below.",
  },
];
...
export function FaqsSection() {
  return (
    <section
      ...
      className="scroll-mt-24 py-16 md:py-24 relative"
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
        ...
        <div
          className="absolute top-40 right-1/3 w-1 h-1 rounded-full bg-purple-300 animate-ping"
          style={{ animationDelay: "0.5s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/3 w-1 h-1 rounded-full bg-cyan-300 animate-ping"
