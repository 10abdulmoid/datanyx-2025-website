  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20 pointer-events-none">
        ...
        <div
          className="absolute top-80 right-1/4 w-1 h-1 rounded-full bg-blue-300 animate-ping"
          style={{ animationDelay: "1.2s" }}
        ></div>
        <div
          className="absolute bottom-30 left-1/2 w-1 h-1 rounded-full bg-purple-300 animate-ping"
