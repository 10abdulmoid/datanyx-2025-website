          ...
          >
            ...
            {/* <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-10 md:-translate-y-12 hidden lg:block z-30">
              <div
                ...
                style={{ fontFamily: 'Poppins, sans-serif', backgroundColor: '#ffffff', color: '#000', boxShadow: '0 0 20px rgba(255,255,255,0.5)' }}
              >
                START
              </div>
            </div> */}
            ...
            <div>
              {TIMELINE_EVENTS.map((event, index) => {
                ...
                const eventProgress =
                  (index / (TIMELINE_EVENTS.length - 1)) * 100;
                      ...
                      style={{
                        width:
                          windowWidth >= 1024
                            ...
                            : "calc(100% - 4rem)",
                        paddingRight:
                          windowWidth >= 1024 && isLeft ? "2rem" : "0rem",
                        paddingLeft:
                          windowWidth >= 1024 && !isLeft ? "2rem" : "0rem",
                        marginLeft:
                          windowWidth >= 1024
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <h4 className="text-lg md:text-xl lg:text-2xl font-bold text-white mb-2 md:mb-3 leading-tight">
                            {event.title}
                          </h4>
