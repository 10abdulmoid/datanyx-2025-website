...
const RegistrationClosedBanner = () => {
  return (
    <div className="w-full overflow-hidden bg-[#00ff9d] py-1 text-black font-bold uppercase tracking-widest shadow-[0_-4px_20px_rgba(0,255,157,0.3)]">
      <div className="relative flex overflow-x-hidden">
        <div className="animate-marquee whitespace-nowrap py-1 flex items-center">
          {Array(10).fill(null).map((_, i) => (
            <React.Fragment key={i}>
              <span className="mx-4 text-xs md:text-sm font-extrabold italic">Registrations are already closed</span>
