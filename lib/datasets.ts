  ...
  medtech: [
    {
      ...
      private: {
        ...
        description: "Ravi Pal, a para-athlete who won gold and bronze medals for the country, recently shared that despite bringing international glory to India, he was forced to leave his home stadium because it lacked even the basic training support and facilities (<a href='https://timesofindia.indiatimes.com/city/dehradun/para-athletes-struggle-amid-lack-of-support-and-facilities/articleshow/112870146.cms' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>). He isn't an exception; almost every para-athlete faces the similar systemic struggles; training without personalized guidance, living without structured nutrition or hydration plans, and having no tools to monitor fatigue, recovery, or injury risk. Slowly, these invisible gaps drain their stamina, increase overuse injuries, delay performance peaks, and dim the potential that deserved better care from the very beginning.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1xrmwIFYerhc_jgC_nX4-mJXcvyCitdMR6x7qJW6kg1E/export?format=xlsx",
      },
    },
    {
      id: "med-2",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1wTvtXyI1ZFEtf6vohwG-aq40vUjoOkZQkhlC4uS6eTY/export?format=xlsx",
      },
    },
    {
      id: "med-3",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1vdfJCxA3EvVzrGyAB6RoJIoQKSlhclw7otC1MG9MVnA/export?format=xlsx",
      },
    },
    {
      id: "med-4",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1YCb4ZLqjLdSKuoMmBnTo37syklv2z3NMahAo-70UCrI/export?format=xlsx",
      },
    },
    {
      id: "med-5",
      ...
      private: {
        ...
        description: "Not all illnesses shout some whisper. Millions live with recurring sneezing, asthma, skin allergies, or chronic fatigue, unaware that these subtle symptoms may point to an underlying immune deficiency Most cases go unnoticed for years. Yet some stories reveal the stakes more clearly, like that of Aisha Chaudhary, who was born with Severe Combined Immunodeficiency (SCID) and required a bone-marrow transplant at six months. Despite early diagnosis, complications took her life at 18 (<a href='https://www.ndtv.com/offbeat/aisha-chaudhary-inspiration-behind-the-sky-is-pink-2099049' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>). Her condition was rare and identified early but countless others remain undiagnosed, living with immune dysfunction that quietly affects daily life without a name.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1CN5mMk4_E_FTqU4AAg0eAKLyM8HqoYRpaKPriMXi1GM/export?format=xlsx",
      },
    },
  ],
  fintech: [
    {
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1MKXO_tjFXvcU9rZHgSax0z4_JDr20w-5wfJ8k7RKYzQ/export?format=xlsx",
      },
    },
    {
      id: "fin-2",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1oIzwmZB__8oRaAnp9nU6O9vJiI4TGohJlO6R2DXyKE4/export?format=xlsx",
      },
    },
    {
      id: "fin-3",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1vmAb4IpdJMoIitoSR9PQQ2Q_us1pq_vgxo8CgURt_UU/export?format=xlsx",
      },
    },
    {
      id: "fin-4",
      ...
      private: {
        ...
        description: "In recent years, India's startup scene has grown rapidly, with new founders entering the ecosystem every day and early successes creating massive excitement. Yet behind this momentum lies a harsh truth: nearly 90% of Indian startups fail within their first five years, as highlighted in multiple founder case studies. (<a href='https://techiexpert.com/why-90-startups-fail-brutally-honest-insights/' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>) Stories like Stayzilla, TinyOwl, and Byju's show how even promising companies can collapse when financial clarity is missing. Many founders only realize trouble when cash starts running out or growth slows unexpectedly, often too late to recover. These real-world failures reveal a deeper pattern most startups struggle due to limited visibility into their financial health, causing early warning signs to be overlooked.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1pgP8dE4ikpacoYY3CtGhY-kuiXEUGN-BrfYGnPA2OfI/export?format=xlsx",
      },
    },
    {
      id: "fin-5",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1bSS7AAgA7wD3AykzwMFkVzwciGLPgN1c8jASLiZ4pnI/export?format=xlsx",
      },
    },
  ],
  agrotech: [
    {
      ...
      private: {
        ...
        description: "According to The Shillong Times, Meghalaya recorded the highest monsoon rainfall deficit in India at 45%. (<a href='https://theshillongtimes.com/2025/08/12/meghalayas-monsoon-rainfall-deficit-highest-in-india-at-45/' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News reference</a>) Agriculture supports about 70% of the population and contributes around 22% of the state's GSDP, with crops such as rice, maize, pulses, ginger, and spices thriving in the region's hilly terrain. Despite strong organic farming yields, farmers lack structured, data-driven decision-support tools, leading to inconsistent productivity and increased vulnerability to climate risks.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1WHftrP1yHApyCfq7qBDkxJ8rzpGE3__FiH54nzKcHLo/export?format=xlsx",
      },
    },
    {
      id: "agro-2",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1Vsw2dTVwo5rZ17zIPtuPmgJ6Rzb0qkhhh4w4nHgX1bs/export?format=xlsx",
      },
    },
    {
      id: "agro-3",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1PBsp619etisMGXk9iFXBZlepmekr7mgppCW2NQ9uzd8/export?format=xlsx",
      },
    },
    {
      id: "agro-4",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1FCVWmNJT-CRqUAM-FWJ-6OXoj8HVZfZ-b1OhoajpHh0/export?format=xlsx",
      },
    },
    {
      id: "agro-5",
      ...
      private: {
        ...
        description: "Indian soils have supported crop cultivation for centuries, but centuries of continuous farming without proper replenishment have left them depleted and exhausted, resulting in some of the lowest crop yields in the world. Only about 30% of farmers use balanced NPK fertilizers, while India remains the world's second-largest fertilizer consumer, applying over 55 million tons annually. Soil erosion claims nearly 5.3 billion tonnes of fertile topsoil every year, and uneven access to essential manures like cow dung worsens the problem. (<a href='https://indusfood.co.in/article/indias-fertilizer-industry/' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>) Without careful soil nourishment, the productivity of farmland continues to decline, threatening food security and the livelihoods of millions of farmers.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/14EhgyQv_E7WEwWbWL1cZxBEsTiYFjq8Er9VCvXpvWYI/export?format=xlsx",
      },
    },
  ],
  edtech: [
    {
      ...
      private: {
        ...
        description: "In 2019, a Telangana student was initially declared failed after being awarded just 20 marks, but a post-reverification revealed her actual score to be 48. (<a href='https://www.newindianexpress.com/states/telangana/2019/Jun/02/telangana-girl-who-committed-suicide-after-failing-inter-exam-passes-after-re-check-1984896.html' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>) A single human error that changed her fate forever. This tragic incident highlights the impact of manual mistakes in high-stakes evaluations. Competitive examinations such as UPSC Prelims, TG-TET and various state-level educator eligibility tests involve lakhs of answer sheets that are manually evaluated, a slow, error-prone and difficult process. One incorrect tally, mismatched memo or misread score can lead to failed results, lost opportunities, lengthy appeals, and in extreme cases, irreversible emotional and mental consequences.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/11zJZ85D1MUkXF7U7w7Ev4AGnJg0YSO-iT2pN3vRaN_Q/export?format=xlsx",
      },
    },
    {
      id: "ed-2",
      ...
      private: {
        ...
        description: "Across classrooms and workplaces, people increasingly struggle to speak up, collaborate, or feel understood. This isn't just discomfort, it's part of a worsening global loneliness crisis. WHO's 2025 data shows that every sixth person feels chronically lonely, and the emotional damage is serious, contributing to 100 deaths every hour worldwide. (<a href='https://www.newindianexpress.com/nation/2025/Jul/01/lonely-in-world-100-deaths-every-hour-says-who' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>) In classrooms, team activities, or workplace discussions, many people hold back not because they lack ideas, but because they worry about how they will sound or be perceived. They struggle to read social cues, can't tell when to speak, or fear being misunderstood. Over time, this hesitation quietly erodes participation, confidence, and a sense of belonging, making simple group interactions feel overwhelming.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1OrjMF3OVodLNnTYvMl413Uw6fhTeCfg1vY809EDLk-s/export?format=xlsx",
      },
    },
    {
      id: "ed-3",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1bGMofsLeNrFtEI5tYbw7fmy9hGHKOzOC0FyL0OaUTmc/export?format=xlsx",
      },
    },
    {
      id: "ed-4",
      ...
      private: {
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1JmXlrBOdCGQSYeOC77Ehgj_ealCmrmETrKCfxZbp28s/export?format=xlsx",
      },
    },
    {
      id: "ed-5",
      ...
      private: {
        ...
        description: "Across many government schools, classrooms are severely overcrowded, placing teachers under constant stress while directly impacting student safety and learning quality. As reported by the Ministry of Education, overcrowded classrooms contribute to both teacher stress and declining classroom control. (<a href='https://www.fijivillage.com/news/Classroom-overcrowding-causes-stress-and-health-issues-for-teachers--Ministry-of-Education-8f4x5r/' target='_blank' rel='noopener noreferrer' class='text-blue-500 hover:underline'>News Reference</a>) In such chaotic environments, notorious students create disturbances that often go unnoticed, some students slip out of classrooms without permission, and incidents such as talking, copying, cheating, or throwing objects frequently escape attention. More concerning are the silent signals - students lowering their heads, losing curiosity, withdrawing from participation, showing emotional stress, or mentally disengaging which remain invisible in packed classrooms. Teachers, already overburdened, are unable to observe every learner closely. As a result, both discipline and emotional well-being are compromised, while learning outcomes steadily decline.",
        ...
        downloadLink: "https://docs.google.com/spreadsheets/d/1T_IXC6TmUTtKlb3MsWdaaf-Zugx9PC-vsWQLVb7YZFA/export?format=xlsx",
      },
    },
  ],
};
